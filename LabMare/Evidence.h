...
public:
	...
	void setMeasurement(std::string mes) { this->measurement = mes; }
	void setImageClarityLevel(float img) { this->imageClarityLevel = img; }
	void setQuantity(float quant) { this->quantity = quant; }
	void setPhotograph(std::string photo) { this->photograph = photo; }
